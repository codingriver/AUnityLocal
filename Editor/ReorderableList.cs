...
//     public class ObjectFilterReorderableList<TFilter, TData> : ReorderableList<TFilter>
//         where TFilter : class, IObjectFilter<TData>, new()
//     {
//         public override List<TFilter> ParseClipboard(object clipboard)
//         {
//             var result = new List<TFilter>();
//
//             // 处理Unity对象数组（从Asset或Hierarchy选择的对象）
//             if (clipboard is UnityEngine.Object[])
//             {
...
//                     if (obj == null) continue;
//
//                     TFilter filter = ProcessUnityObject(obj);
//                     if (filter != null)
//                     {
//                         result.Add(filter);
//                     }
...
//
//                     // 尝试解析数据
//                     TData parsedData = ParseLineToData(trimmedLine);
//                     if (parsedData != null)
//                     {
...
//         /// 处理Unity对象，将其转换为TFilter
//         /// </summary>
//         private TFilter ProcessUnityObject(UnityEngine.Object obj)
//         {
//             try
//             {
//                 TFilter filter = new TFilter();
//                 filter.Valid = true;
//
//                 TData convertedData = ConvertUnityObjectToData(obj);
//                 if (convertedData != null)
//                 {
//                     filter.data = convertedData;
//                     return filter;
//                 }
//             }
//             catch (System.Exception ex)
...
//         /// 将Unity对象转换为目标数据类型
//         /// </summary>
//         private TData ConvertUnityObjectToData(UnityEngine.Object obj)
//         {
...
//         /// 转换GameObject到目标数据类型
//         /// </summary>
//         private TData ConvertGameObjectToData(GameObject gameObject, Type dataType)
//         {
//             // 如果目标类型是GameObject
//             if (dataType == typeof(GameObject))
//             {
//                 return (TData)(object)gameObject;
//             }
//
//             // 如果目标类型是Transform
//             if (dataType == typeof(Transform))
//             {
//                 return (TData)(object)gameObject.transform;
//             }
//
//             // 如果目标类型是字符串，返回名称
//             if (dataType == typeof(string))
//             {
//                 return (TData)(object)gameObject.name;
//             }
//
//             // 如果目标类型是Vector3，返回位置
//             if (dataType == typeof(Vector3))
//             {
//                 return (TData)(object)gameObject.transform.position;
//             }
//
//             // 尝试获取指定类型的组件
//             if (typeof(Component).IsAssignableFrom(dataType))
...
//         /// 转换Component到目标数据类型
//         /// </summary>
//         private TData ConvertComponentToData(Component component, Type dataType)
//         {
//             // 直接类型匹配
//             if (dataType.IsAssignableFrom(component.GetType()))
//             {
...
//             if (dataType == typeof(GameObject))
//             {
//                 return (TData)(object)component.gameObject;
//             }
//
//             // 如果目标类型是Transform
//             if (dataType == typeof(Transform))
//             {
//                 return (TData)(object)component.transform;
//             }
//
//             // 如果目标类型是字符串，返回组件名称
//             if (dataType == typeof(string))
//             {
//                 return (TData)(object)component.name;
//             }
//
//             // 如果目标类型是Vector3且组件是Transform，返回位置
//             if (dataType == typeof(Vector3) && component is Transform transform)
//             {
//                 return (TData)(object)transform.position;
//             }
//
//             // 尝试从同一GameObject获取目标类型组件
//             if (typeof(Component).IsAssignableFrom(dataType))
...
//                 if (targetComponent != null)
//                 {
//                     return (TData)(object)targetComponent;
//                 }
//             }
//
//             return default(TData);
...
//         /// 转换Asset到目标数据类型
//         /// </summary>
//         private TData ConvertAssetToData(UnityEngine.Object asset, Type dataType)
//         {
//             // 直接类型匹配
//             if (dataType.IsAssignableFrom(asset.GetType()))
//             {
//                 return (TData)(object)asset;
//             }
//
//             // 如果目标类型是字符串，返回资源名称
//             if (dataType == typeof(string))
//             {
//                 return (TData)(object)asset.name;
//             }
//
//             // 特殊处理：Texture到Sprite的转换
//             if (dataType == typeof(Sprite) && asset is Texture2D texture)
...
//             if (dataType == typeof(Texture2D) && asset is Sprite sprite1)
//             {
//                 return (TData)(object)sprite1.texture;
//             }
//
//             return default(TData);
//         }
//
// // 保持原有的ParseLineToData等方法不变...
//         private TData ParseLineToData(string line)
//         {
//             Type dataType = typeof(TData);
//
//             try
...
//                 {
//                     if (int.TryParse(line, out int intValue))
//                         return (TData)(object)intValue;
//                 }
//                 else if (dataType == typeof(float))
//                 {
//                     if (float.TryParse(line, out float floatValue))
//                         return (TData)(object)floatValue;
//                 }
//                 else if (dataType == typeof(double))
//                 {
//                     if (double.TryParse(line, out double doubleValue))
//                         return (TData)(object)doubleValue;
//                 }
//                 else if (dataType == typeof(bool))
//                 {
//                     if (bool.TryParse(line, out bool boolValue))
//                         return (TData)(object)boolValue;
//                 }
//                 else if (dataType == typeof(Vector2))
//                 {
//                     return ParseVector2(line);
...
//                 {
//                     // 尝试通过名称或路径查找Unity对象
//                     return FindUnityObject(line, dataType);
//                 }
//                 else if (dataType.IsEnum)
//                 {
//                     if (System.Enum.TryParse(dataType, line, true, out object enumValue))
//                         return (TData)enumValue;
//                 }
//             }
//             catch (System.Exception ex)
//             {
...
//         }
//
//         private TData ParseVector2(string line)
//         {
//             // 支持格式: "1,2" 或 "(1,2)" 或 "1 2"
//             string cleaned = line.Trim('(', ')', ' ');
//             string[] parts = cleaned.Split(new[] { ',', ' ' }, StringSplitOptions.RemoveEmptyEntries);
...
//                 float.TryParse(parts[1], out float y))
//             {
//                 return (TData)(object)new Vector2(x, y);
//             }
//
//             return default(TData);
//         }
//
//         private TData ParseVector3(string line)
//         {
//             // 支持格式: "1,2,3" 或 "(1,2,3)" 或 "1 2 3"
//             string cleaned = line.Trim('(', ')', ' ');
//             string[] parts = cleaned.Split(new[] { ',', ' ' }, StringSplitOptions.RemoveEmptyEntries);
...
//                 float.TryParse(parts[2], out float z))
//             {
//                 return (TData)(object)new Vector3(x, y, z);
//             }
//
//             return default(TData);
//         }
//
//         private TData ParseColor(string line)
//         {
//             // 支持十六进制颜色 "#RRGGBB" 或 "RRGGBB"
//             if (line.StartsWith("#"))
//                 line = line.Substring(1);
...
//                 float g = ((colorValue >> 8) & 0xFF) / 255f;
//                 float b = (colorValue & 0xFF) / 255f;
//                 return (TData)(object)new Color(r, g, b, 1f);
//             }
//
//             return default(TData);
//         }
//
//         private TData FindUnityObject(string line, Type objectType)
//         {
//             // 尝试通过名称查找对象
//             if (objectType == typeof(GameObject))
//             {
//                 GameObject found = GameObject.Find(line);
//                 if (found != null)
//                     return (TData)(object)found;
//             }
//
//             // 尝试通过AssetDatabase查找资源
//             string[] guids = AssetDatabase.FindAssets($"{line} t:{objectType.Name}");
//             if (guids.Length > 0)
//             {
//                 string assetPath = AssetDatabase.GUIDToAssetPath(guids[0]);
//                 UnityEngine.Object asset = AssetDatabase.LoadAssetAtPath(assetPath, objectType);
//                 if (asset != null)
//                     return (TData)(object)asset;
//             }
//
...
//
//         // 数据验证回调
//         public Func<TData, bool> OnValidateData;
//
//         // 数据转换回调（用于复杂类型的处理）
//         public Func<TData> OnCreateDefaultData;
//
//         public ObjectFilterReorderableList(
//             List<TFilter> dataList,
//             string headerText, string str = null, EditorWindow window = null)
//             : base(dataList, headerText)
//         {
//             // 设置默认的绘制和添加回调
...
//
//             DrawDataField(currentRect, index,filter);
//         }
//
//         private void DrawDataField(Rect rect, int index,TFilter filter)
//         {
//             if (OnDrawDataField != null)
//             {
//                 // 使用自定义绘制
//                 OnDrawDataField.Invoke(rect, filter.data, (newData) =>
//                 {
//                     if (OnValidateData == null || OnValidateData(newData))
//                     {
//                         filter.data = newData;
//                     }
//                 });
...
//             {
//                 // 默认绘制逻辑
//                 DrawDefaultDataField(rect, index,filter);
//             }
//         }
//
//
...
//         T data { get; set; }
//     }
//     public class ObjectFilter<T>:IObjectFilter<T>
//     {
